...
ath.intl = {
	...
	en_us: {
		ios: 'Want to have all the events at your fingertips? To add this web app to the home screen: tap %icon and then <strong>Add to Home Screen</strong>.',
		android: 'Want to have all the events at your fingertips? Add this web app to the home screen, open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>'
	},
